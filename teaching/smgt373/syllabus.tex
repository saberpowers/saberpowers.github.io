...
\begin{adjustwidth}{1cm}{0cm}
  ...
  \begin{itemize}
    \item {\bf Job Description.} This job description (JD) must include a list of job responsibilities with percentage weights that sum to $100\%$. If your JD does not include these weights, ask your internship supervisor to help you add them to the JD.
