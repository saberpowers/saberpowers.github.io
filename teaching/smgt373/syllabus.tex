...
\begin{adjustwidth}{1cm}{0cm}
  For permission to register, send the instructor an email meeting the following criteria:
  \begin{itemize}
    \item You have CC'd your internship supervisor on the email.
    \item You have attached a Job Description (JD) with a list of job responsibilities with percentage weights that sum to $100\%$. If your JD does not include weights, ask your internship supervisor to help you add them to the JD.
    \item You have attached a Supervisor Acknowledgment Form completed by your internship supervisor. \url{https://saberpowers.github.io/teaching/smgt373/acknowledgment.pdf}
    \item You have included your Student ID in the email.
  \end{itemize}
  After registering, update your credit hours to reflect your desired enrollment (default is $1$ credit hour). \url{https://registrar.rice.edu/students/updating_variable_credit}
\end{adjustwidth}
