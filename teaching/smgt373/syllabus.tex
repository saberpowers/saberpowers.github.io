...
\begin{adjustwidth}{1cm}{0cm}
  ...
  \item After sending the email, submit a Course Registration Override request following the instructions at \url{https://registrar.rice.edu/course-registration-override-request-process}.
  ...
  \item After registering, you can update your variable credit hours (if necessary) following the instructions at \url{https://registrar.rice.edu/students/updating_variable_credit}.
  \end{enumerate}
\end{adjustwidth}
