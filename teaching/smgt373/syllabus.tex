...
\begin{minipage}[c]{0.6\linewidth}
  \raggedleft
  {\bf Course:} SMGT $430/530$ -- Sport Analytics Internship
\end{minipage}
...
\begin{adjustwidth}{1cm}{0cm}
  \begin{enumerate}
    \item You must secure your internship before registering for the course. The internship must be in sport analytics, and the instructor reserves the right to reject an internship of insufficient caliber.
...
\begin{adjustwidth}{1cm}{0cm}
  For permission to register for this course, you must send an email to the instructor with two attachments:
  \begin{itemize}
    \item {\bf Job Description.} This job description must include a list of job responsibilities with percentage weights that sum to $100\%$. If your job description does not include these weights, ask your internship supervisor to help you add them to the job description.
...
\begin{adjustwidth}{1cm}{0cm}
  ...
  You will perform at least $150$ hours of work ($50$ work hours for every credit hour) for the organization and a detailed log must be kept to record hours performed. Your hours must be submitted to Canvas so there is a clear record of your progress. We may also request to verify hours via pay stubs, a spreadsheet signed by your supervisor, etc. Completion of hours is a significant part of your grade for this class.
...
\begin{adjustwidth}{1cm}{0cm}
  ...
  \end{center}
  ~\\
	\textbf{Hour Logs.} ($50$pts) There are $7$ bi-weekly hour logs, each worth $7$--$8$pts. Late hour logs are subject to $1$pt penalty for each day they are late. Submitting your log $30$ minutes late counts as submitting it $1$ day late. The deadline to complete your $150$ hours is the last day of classes for the semester. If you are not able to complete your hours by the deadline, your grade will drop by $1$pt for every $2$ hours you are deficient.

  \textbf{Midterm Performance Evaluation.} ($25$pts) It is your responsibility to remind your internship supervisor to complete your midterm performance evaluation halfway through the semester.

  \textbf{Final Performance Evaluation.} ($25$pts) It is your responsibility to remind your internship supervisor to complete your final performance evaluation at the end of the semester.
\end{adjustwidth}
