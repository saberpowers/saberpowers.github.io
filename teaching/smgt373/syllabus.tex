...
\begin{adjustwidth}{1cm}{0cm}
  ...
  \begin{itemize}
    ...
    \item You have attached a Supervisor Acknowledgment Form completed by your internship supervisor. \url{https://saberpowers.com/teaching/smgt373/acknowledgment.pdf}
    \item You have included your Student ID in the email.
  \end{itemize}
  {\bf After the instructor submits a seat limit override for you, you must then register for the course.}

  After registering, please check the number of credit hours for which you are enrolled. If you need to update your credit hours to reflect your desired enrollmemnt, you may do so by following the instructions at \url{https://registrar.rice.edu/students/updating_variable_credit}
\end{adjustwidth}
