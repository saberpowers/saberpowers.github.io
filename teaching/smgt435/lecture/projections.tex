...
\begin{document}
  ...
  \subsection{\sc Discussion}
    ...
    \begin{enumerate}
      \item What do you view as the most substantial limitations of the Marcel the Monkey Forecasting System?
      \begin{enumerate}
        \item What incorrect assumption(s) does the projection system make, and what are the consequences of the assumption(s) being violated?
        \item What are the most important factors that the projection system does not take into account, and how do you think you could modify the system to account for these factors?
      \end{enumerate}
    \end{enumerate}
