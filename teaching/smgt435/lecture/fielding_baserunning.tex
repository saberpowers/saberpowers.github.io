...
\begin{document}
  ...
  \begin{framed}
    {\sc Warm-Up}\\
    \begin{itemize}
      \item Find the Fielding Run Value leaderboard on Baseball Savant. How does the scale of the Range column compare with the scale of the Arm column? What does this mean? What else do you find interesting about this leaderboard?
      \item Find the Baserunning Run Value leaderboard on Baseball Savant. What seems to be more important: Runs via Extra Bases Taken or Runs Via Stolen Bases? What else do you find interesting about this leaderboard?
    \end{itemize}
  \end{framed}
  ...
  \section{\sc Fielding and Baserunning}
    ...
    \subsection{\sc Discussion}
      ...
      \begin{enumerate}
        \item Find the Outfielder Jump Leaderboard on Baseball Savant. How does the information here differ from what is available on the Fielding Run Value Leaderboard? If you were a general manager, which information would you rather use to evaluate players in trades or free agency?
        \item Find the Sprint Speed Leaderboard on Baseball Savant. How does the information here differ from what is available on the Baserunning Run Value Leaderboard? If you were a general manager, which information would you rather use to evaluate players in trades or free agency?
      \end{enumerate}
