  ...
  \section*{\sc Assignment: Pitch Outcome Model}
    ...
    \subsection*{\sc Deliverables}
      ...
      \begin{itemize}
        ...
        \item A CSV of predictions, with columns \texttt{index} and \texttt{prob\_contact}
