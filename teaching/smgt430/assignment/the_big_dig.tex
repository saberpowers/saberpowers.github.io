...
\usepackage{array, graphicx, fancyhdr}

\pagestyle{fancy}

\fancyfoot[R]{\sc \footnotesize Written by Brady Detwiler and Scott Powers}

\begin{document}

  \section*{\sc The Big Dig}

    Our goal on this assignment is to improve upon hitting percentage for evaluating attackers in Major League Volleyball (MLV). We will first develop a touch-by-touch pont win probability model and then evaluate attackers based the difference in their teams' point win probabilities before and after their attacks.
    ...
    \subsection*{\sc Instructions}
      ...
      \begin{itemize}
        \item {\bf Introduction.} Explain succinctly why your analysis matters (one pithy paragraph).
