...
\begin{document}
  ...
  \section*{\sc The Big Dance}
    ...
    Our goal on this assignment is to evaluate three-point shooters in NCAA women's basketball. This is an example of an important job function for analysts working in basketball front offices because evaluating talent is the starting point for player personnel decisions (draft, trades, free agency, etc.).
