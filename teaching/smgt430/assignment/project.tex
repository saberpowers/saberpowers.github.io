  ...
  \section*{\sc Project \#3: Presentation}
    ...
    \subsection*{\sc Rubric}
      ...
      \begin{tabular}{|>{\centering\arraybackslash}p{2.5cm}|>{\centering\arraybackslash}p{5cm}|>{\centering\arraybackslash}p{5cm}|>{\centering\arraybackslash}p{5cm}|}
        ...
        Clarity \newline (25\%)
          \newline ~ & ~ \newline
          \it You did not clearly communicate what you did (methods), or you did not clearly communicate why you did it (motivation).
          \newline ~ & ~ \newline
          \it You cearly communicated your motivation and your methods although some important details may not have been clear.
          \newline ~ & ~ \newline
          \it You clearly communicated your motivation, methods and all details, leaving the audience with no clarifying questions.
          \newline ~\\
        \hline
        ~ \newline
        Display \newline (25\%)
          \newline ~ & ~ \newline
          \it Some of your slides contained too much text or too much detail, or some of the text was too small for the audience.
          \newline ~ & ~ \newline
        ...
        Delivery \newline (25\%)
          \newline ~ & ~ \newline
          \it You avoided looking at the audience, or you spoke with a flat, impersonal tone as if reading a prepared statement.
          \newline ~ & ~ \newline
