...
2:30-2:35
- "I was wondering if Markov could be useful for deciding pinch hitting. I brought it up to my group but we didn't really discuss it and I didn't get a chance to ask in class."
- "Would building a location-based model for a single hole be too restrictive based on sample, or too intensive to have positive reward vs effort? Or would a non-location model just be too inaccurate?"
