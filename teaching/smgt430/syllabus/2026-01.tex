...
\begin{adjustwidth}{1cm}{0cm}
  ...
  {\bf Office Hours:} $12$:$00$ -- $12$:$50$ p.m. Tue, $1$:$00$ -- $1$:$50$ p.m. Thu
\end{adjustwidth}
...
\textbf{\textsc{Topics}}
\begin{adjustwidth}{1cm}{0cm}
  The general flow is that we will alternate between (a) discussing math/models using a whiteboard and (b) implementing these concepts in code. The course is divided into $3$ units, each approximately $4$ weeks:
  \begin{itemize}
    ...
    Regression to the Mean, Multilevel Models, Projections, Regularized Adjsted Plus-Minus
    \item Unit $3$: \\
...
\begin{adjustwidth}{1cm}{0cm}
  ...
  \textbf{Practices.} ($10$pts) There are $3$ individual assignments, each worth $5$pts, each graded for completion. The expected completion time for each practice is $4$ hours.
 
  \textbf{Assignments.} ($40$pts) There are $3$ individual assignments, each worth $15$pts. You are encouraged to help each other, but your submission must reflect work you have done yourself. Assignments will be graded anonymously, so please remove any personally identifying information from your submission. The expected completion time for each assignment is $12$ hours.
  \begin{itemize}
    \item Assignment \#$1$ ($10$pts): The Big Game  \hfill expected hours: $8$
    \item Assignment \#$2$ ($15$pts): The Big Dance \hfill expected hours: $12$
    \item Assignment \#$3$ ($15$pts): The Big Dig   \hfill expected hours: $12$
  \end{itemize}
  ...
  \begin{center}
    \begin{tabular}{llll}
      ...
      Pratice \#1: Figures and Tables           & Jan 28  & Lecture: Bradley-Terry Model\\
                                                & Jan 30  & Review Day\\
      \hline
                                                & Feb  3  & Lecture: ELO Ratings\\
      Assignment \#1: The Big Game              & Feb  5  & Guest: TBA\\
      \hline
                                                & Feb 10  & Workshop: How to Write a Report\\
                                                & Feb 12  & {\bf NO CLASS (SPRING RECESS)}\\
      \hline
                                                & Feb 17  & Game: Free Throw Shooting Contest\\
                                                & Feb 19  & Lecture: Regression to the Mean\\
      \hline
      Practice \#2: Report                      & Feb 24  & Lecture: Multilevel Models\\
                                                & Feb 26  & Lecture: Projections\\
      \hline
                                                & Mar  3  & Review Day\\
                                                & Mar  5  & Lecture: Regularized Adjusted Plus-Minus\\
      \hline
      Project \#0: Registration                 & Mar 10  & Guest: TBA\\
      Assignment \#2: The Big Dance             & Mar 12  & Workshop: How to Get Sports Data\\
      \hline
      ...
      \hline
                                                & Apr 14  & Guest: TBA\\
      Assignment \#3: The Big Dig               & Apr 16  & Workshop: How to Prepare a Presentation\\
      \hline
