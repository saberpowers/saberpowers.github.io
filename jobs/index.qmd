...
- Amanda Glazer's [advice on getting started in sport analytics](https://www.amandaglazer.com/sports-analytics){target=_blank}
- My unsolicited [advice on becoming a competitive candidate for jobs in sport analytics](advice/index.qmd)
...
DT::datatable(
  ...
  options = list(
    columnDefs = list(
      ...
      list(orderData = 10, targets = 2),                    # sort compact date by verbose date
